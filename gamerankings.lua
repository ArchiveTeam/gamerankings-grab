...
allowed = function(url, parenturl)
  if string.match(url, "'+")
      or string.match(url, "[<>\\%*%$;%^%[%],%(%){}]")
      or not (
        string.match(string.lower(url), "^https?://[^/]*gamerankings.com/")
        or string.match(string.lower(url), "^https?://[^/]*cbsistatic%.com/")
      ) then
    return false
  end
  ...
  if string.match(url, "^https?://[^/]*cbsistatic.com") then
    return true
  end
