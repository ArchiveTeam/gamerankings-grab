...
More information about the archiving project can be found on the ArchiveTeam wiki: [GameRankings](http://archiveteam.org/index.php?title=GameRankings)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "GameRankings" project in the Warrior interface.
...
### For Debian/Ubuntu:
    ...
    pip install --upgrade seesaw
    su -c "cd /home/archiveteam; git clone https://github.com/ArchiveTeam/gamerankings-grab.git; cd gamerankings-grab; ./get-wget-lua.sh" archiveteam
    screen su -c "cd /home/archiveteam/gamerankings-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, gamerankings-grab will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/gamerankings-grab/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
...
### For Alpine Linux:
    ...
    git clone https://github.com/ArchiveTeam/gamerankings-grab
    cd gamerankings-grab; ./get-wget-lua.sh
